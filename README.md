...
git lfs pull
```
(If you are new to using git and git LFS there websites might help: [git](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository) [git LFS](https://graphite.com/guides/how-to-use-git-lfs-pull))
